...
class AbstractSimpleAsset(ABC):
	...
	@abstractmethod
	def setTransform(
		self, pos: tuple[float, float, float] = (0, 0, 0), rotation: nptyping.NDArray = np.eye(3)
	):
...
def deSerialiseOption(
	opt_name: str,
	opt_state: dict[str, Any],
	asset: AbstractAsset | AbstractCompoundAsset | AbstractSimpleAsset,
) -> None:
