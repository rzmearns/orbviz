	...
	**kwargs : dict
	...
	def __init__(
		...
		**kwargs,
		...
		self._mesh.set_gl_state(polygon_offset_fill=False, polygon_offset=(0, 0), cull_face=False)
		self.freeze()
	...
	def _update(self):
		...
		if not self._border_color.is_blank:
			...
			self._border.set_data(
				pos=border_pos, color=self._border_color.rgb, width=self._border_width
			)
			self._border.update()
