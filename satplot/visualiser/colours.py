...
def getNumberedColour(num: int, pallette_type: str = "bright") -> nptyping.NDArray | None:
	return {"bright": _brightColDict(num), "paper": _paperColDict(num)}.get(pallette_type, None)
...
def getNumberedLinestyle(num: int) -> str:
	return {0: "solid", 1: "dash", 2: "dashdot", 3: "dot", 4: "longdash", 5: "longdashdot"}.get(
		np.floor(num / max_colours), "solid"
	)
