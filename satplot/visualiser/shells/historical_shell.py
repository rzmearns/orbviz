...
class HistoricalShell():
	def __init__(self, parent_window:QtWidgets.QMainWindow, toolbars:dict[str, controls.Toolbar],
		...
		self._addContext('3D-history', history3d_context.History3DContext('3D-history', self.window, history_data_model))
		self._addContext('2D-history', history2d_context.History2DContext('2D-history', self.window, history_data_model, earth_raycast_data_model))
		self._addContext('sensors-view-history', sensor_views_context.SensorViewsContext('sensors-view-history', self.window, history_data_model, earth_raycast_data_model))
