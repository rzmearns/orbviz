...
class MainWindow(QtWidgets.QMainWindow):
	...
	def __init__(self,	title:str="",
		...
		self.shell_tab_stack = orbviz_widgets.StretchTabWidget()
	...
	def closeEvent(self, event:QtCore.QEvent) -> None:
		...
		if orbviz.threadpool is not None:
			# Clear any waiting jobs
			orbviz.threadpool.clear()
			# Stop active jobs
			orbviz.threadpool.killAll()
		logger.info('Closing orbviz window')
